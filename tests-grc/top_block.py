...
# Title: Top Block
# Generated: Fri Jul 15 18:41:45 2016
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.M4 = M4 = (-2/math.sqrt(10),-1/math.sqrt(10),1/math.sqrt(10),2/math.sqrt(10))
        self.M2 = M2 = (-1/math.sqrt(2),1/math.sqrt(2))

        ##################################################
        # Blocks
        ##################################################
        self.root_raised_cosine_filter_0 = filter.interp_fir_filter_fff(sps, firdes.root_raised_cosine(
        	1, samp_rate, samp_rate/sps, rolloff, 11*sps))
        ...
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_bf((M4), 1)
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.root_raised_cosine_filter_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, self.samp_rate/self.sps, self.rolloff, 11*self.sps))
    ...
    def set_M4(self, M4):
        self.M4 = M4
        self.digital_chunks_to_symbols_xx_0.set_symbol_table((self.M4))
